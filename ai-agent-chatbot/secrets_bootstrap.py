...
async def load_secrets_into_env() -> None:
    """Fetches secrets from ministack Secrets Manager into os.environ before config.py is imported."""
    # config.py loads .env itself via find_dotenv()/load_dotenv(), but that hasn't run yet at this
